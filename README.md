...
After that comes the Profiler; it will check for the repeating code that can be optimized. As soon as, it gets the repeating code, it basically moves the code into compiler (TurboFan).
